...
namespace OpenP2P
{
    public class NetworkClient
    {
        ...
        public void OnResponseHeartbeat(object sender, NetworkMessage message)
        {
            ...
            NetworkConfig.SocketReliableRetryDelay = Math.Max(250, latency * 2);
            Random r = new Random();
            string username = "0123456789012";// ";
