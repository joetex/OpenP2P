...
namespace OpenP2P
{
    ...
    public class NetworkManager
    {
        ...
        public Dictionary<string, INetworkProtocol> protocols = new Dictionary<string, INetworkProtocol>();
        ...
        public void Setup(int localPort, bool _isServer)
        {
            ...
            socket.SetChannel(messageFactory);
        ...
        public virtual NetworkMessageEvent GetChannelEvent(MessageType type)
        {
            return GetChannelEvent((uint)type);
        }

        public virtual NetworkMessageEvent GetChannelEvent(uint id)
        {
        ...
        //    MessageStream response = (MessageStream)channel.CreateMessage(stream.header.channelType);
        ...
        //    {
        //        packet.bytePos = 0;
        //        NetworkMessage msg = (NetworkMessage)channel.CreateMessage(MessageType.STUN);
        ...
        //        return (NetworkMessage)channel.CreateMessage(MessageType.Invalid);
